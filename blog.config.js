...
const BLOG = {
  ...
  NOTION_PAGE_ID:
      process.env.NOTION_PAGE_ID || '6aa3d38121634c3e9ceb392016d96f03',
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，这里是橙制元素OWEMT, 一个打工人, 更是一个干饭人, 欢迎来到我的WEB🎉',
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://owel.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'vp@owel.cn', // 邮箱地址 例如mail@tangly1024.com
  ...
  FONT_AWESOME: process.env.NEXT_PUBLIC_FONT_AWESOME_PATH || 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css', // font-awesome 字体图标地址; 可选 /css/all.min.css ， https://lf9-cdn-tos.tecdntp.com/cdn/expire-1-M/font-awesome/6.0.0/css/all.min.css
  ...
  POSTS_SORT_: process.env.NEXT_PUBLIC_POST_SORT_ || 'notion', // 排序方式 'date'按时间,'notion'由notion控制
  ...
  MUSIC_PLAYER_CDN_URL:
      ...
      'https://lf9-cdn-tos.tecdntp.com/cdn/expire-1-M/aplayer/1.10.1/APlayer.min.js',
  ...
  DESCRIPTION:
      process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个由OrangeWare编辑的站点', // 站点描述，被notion中的页面描述覆盖
